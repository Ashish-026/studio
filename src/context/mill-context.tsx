...
const hardcodedMills: Mill[] = [
  { id: '1', name: 'Bargarh Central Mill', location: 'Bargarh' },
  { id: '2', name: 'Sambalpur Processing Unit', location: 'Sambalpur' },
  { id: '3', name: 'Jharsuguda Storage & Mill', location: 'Jharsuguda' },
];
